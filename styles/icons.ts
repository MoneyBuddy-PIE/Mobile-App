const styles =  ["Caleb", "Liliana", "Ryan", "Nolan", "Jameson", "Oliver", "Adrian", "Andrea", "Brooklynn", "Alexander", "Luis", "Jude", "Chase", "Riley", "Valentina", "Leah", "Aidan", "Sawyer", "George", "Robert"]
