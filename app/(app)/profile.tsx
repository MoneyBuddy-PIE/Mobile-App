                        ...
                        <View style={styles.profileHeader}>
                            ...
                            <View style={styles.profileInfo}>
                                ...
                                <View style={[styles.roleBadge, { backgroundColor: getRoleBadgeColor(subAccount.role) }]}>
                                    <Text style={[styles.roleText, fontStylesSemiBold]}>{getRoleDisplayName(subAccount.role)}</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.infoCard}>
                            ...
                            <View style={styles.infoRow}>
                                ...
                                <Text style={[styles.infoValue, fontStylesSemiBold]}>{user.subAccounts?.length || 0}</Text>
                            </View>
                            <View style={styles.infoRow}>
                                <Text style={[styles.infoLabel, fontStylesRegular]}>Membre depuis</Text>
                                <Text style={[styles.infoValue, fontStylesSemiBold]}>{new Date(user.createdAt).toLocaleDateString("fr-FR")}</Text>
                            </View>
                        </View>
                    </View>
                )}
