...
export default function ProfileForm() {
    ...
    const [icon, setIcon] = useState<{ iconStyle: string; iconName: string }>({
        iconStyle: subAccount?.iconStyle ?? "bottts-neutral",
        iconName: subAccount?.iconName ?? "Mason",
    });
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.descriptionContainer}>
                    <Text style={[styles.subtitle, fontStylesRegular]}>Modifier votre profil !</Text>
                </View>

                {/* Profile picture */}
                <View style={{ ...styles.section, ...styles.sectionCenter }}>
                    <TouchableOpacity style={styles.imageContainer} onPress={() => setVisible(true)}>
                        <Image style={styles.image} source={{ uri: getUri(icon.iconStyle, icon.iconName) }} />
            ...
            <View style={styles.footer}>
                ...
                >
                    <Text style={[styles.createButtonText, fontStylesSemiBold]}>{loading ? "Modification en cours..." : "Modifier le compte"}</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
...
const ModalProfilePicture = ({
    ...
    visible: boolean;
    onClose: () => void;
    changeAvatar: (iconStyle: string, iconName: string) => void;
}) => {
                            ...
                            <View style={styles.iconGroup}>
                                ...
                                <View style={styles.avatarGrid}>
                                    {icon.iconName.map((name) => (
                                        <TouchableOpacity
                                            key={name}
                                            style={[styles.avatarContainer, selectedStyle === name + icon.iconName && styles.avatarContainerSelected]}
                                            onPress={() => {
                                            ...
                                            disabled={loading}
                                        >
                                            <Image style={styles.avatarImage} source={{ uri: getUri(icon.iconStyle, name) }} />
