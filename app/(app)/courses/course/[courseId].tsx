...
export default function CourseReader() {
	...
	// Créer la liste des étapes (section -> quiz -> section -> quiz...)
	...
	const handleVerifyAnswer = () => {
		if (selectedAnswer === null || !currentStep.section.quiz) return;

		const correct = selectedAnswer === currentStep.section.quiz.correctAnswerIndex;
	...
	const renderSectionContent = () => (
		<ScrollView style={styles.contentScrollView} showsVerticalScrollIndicator={false}>
			<Markdown style={markdownStyles}>
				{currentStep.section.content}
			</Markdown>
		</ScrollView>
	);

	const renderQuiz = () => {
		const quiz = currentStep.section.quiz!;
		...
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.content}>
				...
				<View style={styles.mainContent}>
					{currentStep.type === "section" ? renderSectionContent() : renderQuiz()}
				</View>
			</View>
