            ...
            >
                ...
                <View style={styles.header}>
                    ...
                    <Text style={[styles.subtitle, typography.body]}>
                        {isChildAccount ? "Apprendre l'argent en s'amusant" : "Comprendre l'argent pour mieux l'expliquer"}
                    </Text>
                </View>
                ...
                <View style={styles.chaptersContainer}>
                    {filteredChapters.length > 0 ? (
                        <View style={styles.chaptersGrid}>{filteredChapters.map((chapter, index) => renderChapterCard(chapter, index))}</View>
                    ) : (
