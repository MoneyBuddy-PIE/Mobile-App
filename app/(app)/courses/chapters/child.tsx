...
import { SafeAreaView, View, Text, StyleSheet, TouchableOpacity, ScrollView, RefreshControl, Image, ActivityIndicator } from "react-native"
    ...
    return (
        <SafeAreaView style={styles.container}>
			...
			<View style={styles.header}>
					...
					<Text style={[styles.subtitle, typography.body]}>Compte, compare les prix et apprends à utiliser l’argent au quotidien.</Text>
			</View>
...
const ChapterCard = ({chapter}: {chapter: Chapter}) => {
    const uri = `https://pub-ce5bc62138bd4218b56745b7ccca587e.r2.dev/${chapter.imageUrl}`

    return (
        <TouchableOpacity
            style={styles.chapterCard}
            onPress={() => {router.push({pathname: 'courses/chapters/courses/child', params: {chapterId: chapter.id}})}}
        >
            ...
            {chapter.progressPercentage > 0
                ? <View style={styles.trackWrap}><View style={[styles.fill, { width: `${chapter.progressPercentage}%`, backgroundColor: '#75B7FF' }]} /></View>
