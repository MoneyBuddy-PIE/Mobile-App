...
import { Chapter, ChapterChildCategory } from "@/types/Chapter"
...
const ChildCategoryPage = () => {
	...
	const handleCategoryPress = (cat: string, chaptersLength: number) => {
		if (chaptersLength > 0)
			return router.push({pathname: 'courses/chapters/child', params: {category: cat}})
	}
						...
						return (
							...
							>
								...
								<View style={styles.trackWrap}>
									<View style={
										[styles.fill, 
										{ width: `${chaptersOfCategory?.reduce(
