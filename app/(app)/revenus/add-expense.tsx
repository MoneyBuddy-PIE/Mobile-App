...
import { View, Text, StyleSheet, SafeAreaView, TextInput, TouchableOpacity, Alert, ScrollView, Animated } from "react-native";
    ...
    return (
        <SafeAreaView style={styles.container}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.categoriesContainer}>
                        {PREDEFINED_CATEGORIES.map((category) => (
                            <TouchableOpacity
                                key={category.label}
                                style={[styles.categoryButton, selectedCategory === category.label && styles.categoryButtonSelected]}
                                onPress={() => handleCategorySelect(category.label)}
                            >
                                <Text style={styles.categoryEmoji}>{category.emoji}</Text>
                                <Text style={[styles.categoryText, selectedCategory === category.label && styles.categoryTextSelected]}>
                                    {category.label}
                                </Text>
                            </TouchableOpacity>
                        ))}
            ...
            <View style={styles.footer}>
                <TouchableOpacity
                    style={[styles.addButton, (!getFinalAmount() || !getFinalDescription() || loading) && styles.addButtonDisabled]}
                    onPress={handleAddExpense}
                    disabled={!getFinalAmount() || !getFinalDescription() || loading}
                >
                    <Text style={styles.addButtonText}>{loading ? "Enregistrement..." : `Dépenser ${getFinalAmount() || "0"}€`}</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
