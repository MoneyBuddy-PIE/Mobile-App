...
import Reanimated, { useSharedValue, useAnimatedProps, withTiming, withDelay, Easing as ReanimatedEasing } from "react-native-reanimated";
    ...
    return (
        <View style={styles.container}>
            <Animated.View style={styles.svgBox}>
                <Svg width={width * 1.1} height={height * 0.4} viewBox="0 0 390 327" style={styles.svgStyle}>
                    <AnimatedPath
                ...
                >
                    <Image source={require("@/assets/indexPage/Sticker_1.png")} />
                </Animated.View>
                ...
                >
                    <Image source={require("@/assets/indexPage/Sticker_2.png")} />
                </Animated.View>
                ...
                >
                    <Image source={require("@/assets/indexPage/Sticker_3.png")} />
                </Animated.View>
                ...
                >
                    <Image source={require("@/assets/indexPage/Sticker_4.png")} />
                </Animated.View>
                ...
                >
                    <Image source={require("@/assets/indexPage/Sticker_5.png")} />
                </Animated.View>
            </Animated.View>
            ...
            <Animated.View style={[styles.content, { opacity: contentAnim }]}>
                ...
                <View>
                    <Text style={typography.subtitleSplash}>
                        ...
                        <Text style={{ textDecorationLine: "underline", cursor: "pointer" }}>Conditions d'utilisation</Text> et notre{" "}
                        <Text style={{ textDecorationLine: "underline", cursor: "pointer" }}>Politique de confidentialité</Text>.
                    </Text>
                </View>
            </Animated.View>
        </View>
