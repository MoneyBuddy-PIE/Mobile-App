...
const CircularProgress = ({ size = 88, strokeWidth = 9, progress = 0, color = "#F06C8A", trackColor = "#EBEBEB", children }: IProps) => {
    ...
    return (
        <View style={{ width: size, height: size }}>
            ...
            <View style={[StyleSheet.absoluteFill, styles.percentCenter]}>
                {children ? children : <Text style={styles.percentText}>{Math.round(progress)}%</Text>}
            </View>
        </View>
    );
};
