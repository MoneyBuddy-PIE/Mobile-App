...
export const LightningIcon: React.FC<LightningIconProps> = ({ width = 24, height = 24, color = "#F2D23D" }) => {
    return (
        <Svg width={width} height={height} viewBox="0 0 512 512">
            ...
            />
            <Path
                d="M183.128,509.336c3.426,1.797,7.131,2.664,10.8,2.664c6.692,0,13.269-2.886,17.811-8.283  l44.26-52.557V0h-15.515c-8.304,0-15.981,4.425-20.14,11.612L49.678,306.398c-4.169,7.201-4.175,16.077-0.022,23.285  c4.156,7.208,11.843,11.649,20.162,11.649h140.196l-38.529,141.27C168.612,493.141,173.454,504.261,183.128,509.336z"
                fill="#EEBF00"
            />
        </Svg>
    );
