...
export default function CourseCard({ course, progress, onPress, imageSource }: CourseCardProps) {
    return (
        <View style={styles.cardContainer}>
            {/* Image placeholder */}
            <View style={styles.imageContainer}>
                {imageSource ? <Image source={imageSource} style={styles.image} resizeMode="cover" /> : <View style={styles.imagePlaceholder} />}
            </View>
